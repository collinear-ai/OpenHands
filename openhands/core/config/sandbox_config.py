...
class SandboxConfig(BaseModel):
    ...
    Attributes:
        ...
        docker_client_timeout: Timeout (seconds) for Docker SDK operations, allowing long builds/starts before
            declaring failure. When unset, defaults to a conservative value derived from sandbox.timeout.
    ...
    docker_client_timeout: int | None = Field(default=None)
